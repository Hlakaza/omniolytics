var DatatableRecordSelectionDemo = function () {
  var t = function () {
    var t = $('.m_datatable').mDatatable({
        data: { type: 'remote', source: { read: { url: '' } }, pageSize: 10, saveState: { cookie: !0, webstorage: !0 }, serverPaging: !0, serverFiltering: !0, serverSorting: !0 }, layout: { theme: 'default', class: '', scroll: !0, height: 550, footer: !1 }, sortable: !0, pagination: !0, search: { input: $('#generalSearch') }, columns: [{ field: 'RecordID', title: '#', sortable: !1, width: 40, textAlign: 'center', selector: { class: 'm-checkbox--solid m-checkbox--brand' } }, { field: 'OrderID', title: 'Order ID', filterable: !1, width: 150, template: '{{OrderID}} - {{ShipCountry}}' }, { field: 'ShipCountry', title: 'Ship Country', width: 150, template: function (t) { return t.ShipCountry + ' - ' + t.ShipCity } }, { field: 'ShipCity', title: 'Ship City', sortable: !1 }, { field: 'Currency', title: 'Currency', width: 100 }, { field: 'ShipDate', title: 'Ship Date', sortable: 'asc' }, { field: 'Latitude', title: 'Latitude' }, {
          field: 'Status', title: 'Status', template: function (t) {
            var e = { 1: { title: 'Pending', class: 'm-badge--brand' }, 2: { title: 'Delivered', class: ' m-badge--metal' }, 3: { title: 'Canceled', class: ' m-badge--primary' }, 4: { title: 'Success', class: ' m-badge--success' }, 5: { title: 'Info', class: ' m-badge--info' }, 6: { title: 'Danger', class: ' m-badge--danger' }, 7: { title: 'Warning', class: ' m-badge--warning' } }
    ...
    $('#m_form_status').on('change', function () {
      ...
      var l = t.getSelectedRecords().length
...
jQuery(document).ready(function () { DatatableRecordSelectionDemo.init() })
